// GENERATED AUTOMATICALLY FROM 'Assets/Scripts/Player/Input System/Player Controller Original.inputactions'
...
public class @PlayerControllerOriginal : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @PlayerControllerOriginal()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Player Controller Original"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @PlayerControllerOriginal m_Wrapper;
        public PlayerActions(@PlayerControllerOriginal wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @PlayerControllerOriginal m_Wrapper;
        public UIActions(@PlayerControllerOriginal wrapper) { m_Wrapper = wrapper; }
