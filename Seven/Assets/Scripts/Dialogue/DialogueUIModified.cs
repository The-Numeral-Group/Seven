...
//This class is meant to imitiate yarn spinner DialogueUI, but with some modifcations I (Ram) want to add.
public class DialogueUIModified : Yarn.Unity.DialogueUIBehaviour
{
        /// <summary>
        ...
        private IEnumerator DoRunLine(Yarn.Line line, ILineLocalisationProvider localisationProvider, System.Action onComplete) {
            ...
            //Rams modifications. Credit: https://www.youtube.com/watch?v=gJrf6ON5UPE&t=333s user Shinjingi
            MenuManager.DIALOGUE_MENU.untrimmedText = text;
            onLineStart?.Invoke();
            try
            {
