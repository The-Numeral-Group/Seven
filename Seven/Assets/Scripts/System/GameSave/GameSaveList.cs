...
public class GameSaveList : MonoBehaviour
{
    ...
    {
        // Just Debugging purpose, does not update anything yet.
        ...
        {
            Debug.Log("Apathy hasn't been defeated.");
        }
        ...
        {
            Debug.Log("Desire hasn't been defeated.");
        }
        ...
        {
            Debug.Log("Ego hasn't been defeated.");
        }
        ...
        {
            Debug.Log("Indulgence hasn't been defeated.");
        }
    }
}
