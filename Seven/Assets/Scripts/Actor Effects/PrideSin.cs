...
public class PrideSin : MonoBehaviour, ActorEffect
{
    ...
    */
    ...
    void Start()
    {
        ...
        //ha Ha aint these some doozys! That's low level assignments for ya!
        //seriously I (Thomas) am not sure what the high level solution is to making things respond to certain actions
        //Maybe we should have made input invoke events instead of send messages? Oh well, lessons learned.
        actionOnInput = new System.Action<InputAction.CallbackContext>((InputAction.CallbackContext c) => 
            {
                Debug.Log("PrideSin: input triggered");
                OnInteract();
            }
        );
        interactAction = playerObj.GetComponent<PlayerInput>().actions.FindActionMap("Player", true).FindAction("Interact", true);
    ...
    void BuildStatue()
    {
        ...
        sprite.color = new Color(sprite.color.r, sprite.color.g - 100, sprite.color.b);
        ///DEGUB
